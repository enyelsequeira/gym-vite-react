...
const FeatureItem = ({ title, description, isActive, onClick }: FeatureItemProps) => {
  return (
    <Box className={`${classes.featureItem} ${isActive ? classes.active : ''}`} onClick={onClick}>
...
const Features = () => {
  ...
  const setImageRef = useCallback((el: HTMLImageElement | null, index: number) => {
