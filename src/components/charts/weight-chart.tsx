import type { UserWeights } from '@/modules/overview/queries/get-user-weights.ts';
...
const WeightChartCard = ({ weights }: Props) => {
  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder>
      <Card.Section withBorder inheritPadding py="xs" mb="md" bg="blue.0">
      ...
      <Stack gap="xs" mb="lg">
        ...
        <Group gap="xs">
          {weightChange !== 0 && (
            <>
              {isWeightLoss ? (
                <IconArrowDownRight size={20} style={{ color: 'teal.6' }} />
              ) : (
                <IconArrowUpRight size={20} style={{ color: 'red.6' }} />
              )}
